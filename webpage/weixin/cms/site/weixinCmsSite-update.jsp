...
<html>
 <head>
  ...
  $(function () {
      ...
      //编辑时初始化图片预览
      var name = "${weixinCmsSitePage.siteName}", imageHref = "${weixinCmsSitePage.siteLogo}";
      if(name != ""){
          $("#imageTitle").html(name);
      }
      if(imageHref != ""){
          $("#imageShow").html('<img src="${weixinCmsSitePage.siteLogo}" width="100%" height="160" />');
      }
  });
  ...
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="weixinCmsSiteController.do?doUpdate" tiptype="1">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <input id="siteName" name="siteName" value="${weixinCmsSitePage.siteName}"  type="text" style="width: 300px" class="inputxt"  datatype="*" >
				...
				<tr>
					...
					<td class="value">
					     	 <input id="siteCode" name="siteCode" type="text" value="${weixinCmsSitePage.siteCode}" style="width: 300px" class="inputxt" datatype="*" >
							<span class="Validform_checktip"></span>
							<label class="Validform_label" style="display: none;">站点code</label>
					</td>
				</tr>
				<tr>
					<td align="right">
					...
					<td class="value">
							<span class="btn btn-success fileinput-button">
					     	...
					     	<input id="siteLogo" name="siteLogo" type="hidden" value="${weixinCmsSitePage.siteLogo}" style="width: 150px" class="inputxt">
				...
				<tr>
					...
					<td class="value">
							...
							<t:dictSelect field="siteTemplateStyle"  dictTable="weixin_cms_style where accountid = '${sessionScope.WEIXIN_ACCOUNT.id}'" dictField="id"   dictText="template_name" defaultVal="${weixinCmsSitePage.siteTemplateStyle}"></t:dictSelect>
							<span class="Validform_checktip"></span>
               ...
               <tr>
                ...
                <td class="value">
                    ...
                    <t:dictSelect field="comment" id="comment"  typeGroupCode="yesorno" hasLabel="false" defaultVal="${weixinCmsSitePage.comment}" ></t:dictSelect>
                    <span class="Validform_checktip"></span>
                    <label class="Validform_label" style="display: none;">允许匿名评论</label>
                </td>
            </tr>
            <tr>
                <td align="right">
                ...
                <td class="value">
                    ...
                    <t:dictSelect field="commentCheck" id="commentCheck"  typeGroupCode="yesorno" hasLabel="false" defaultVal="${weixinCmsSitePage.commentCheck}" ></t:dictSelect>
                    <span class="Validform_checktip"></span>
                    <label class="Validform_label" style="display: none;">评论是否需要审核</label>
                </td>
            </tr>
			</table>
		</t:formvalid>
