...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="weixinCmsSiteList" checkbox="true" fitColumns="false" title="网站管理" actionUrl="weixinCmsSiteController.do?datagrid" idField="id" fit="true" queryMode="group">
   <t:dgCol title="主键"  field="id"  hidden="false"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="创建人名称"  field="createName"  hidden="false"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="创建日期"  field="createDate"  hidden="false"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="修改人名称"  field="updateName"  hidden="false"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="修改日期"  field="updateDate"  hidden="false"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="站点名称"  field="siteName"  hidden="true"  queryMode="single"  width="120" url="cmsController.do?goPage&page=index&siteCode={siteCode}" ></t:dgCol>
   <t:dgCol title="站点code"  field="siteCode"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="站点logo"  field="siteLogo"  hidden="true"  queryMode="single"  image="true" imageSize="100,50" ></t:dgCol>
   <t:dgCol title="站点模板样式"  field="siteTemplateStyle"  dictionary="weixin_cms_style,id,template_name" hidden="true"  queryMode="single"  width="120"></t:dgCol>
    <t:dgCol title="允许匿名评论"  field="comment"  hidden="true"  queryMode="single" dictionary="yesorno"  image="true"  ></t:dgCol>
      <t:dgCol title="评论需要审核"  field="commentCheck"  hidden="true"  queryMode="single" dictionary="yesorno"  image="true" ></t:dgCol>
