  ...
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="weixinCmsSiteController.do?doAdd" tiptype="1">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
					     	 <input id="siteCode" name="siteCode" type="text" style="width: 150px" class="inputxt" datatype="*" >
							<span class="Validform_checktip"></span>
               ...
               <tr>
                ...
                <td class="value">
                    ...
                    <t:dictSelect field="comment" id="comment"  typeGroupCode="yesorno" hasLabel="false" defaultVal="N" ></t:dictSelect>
                    <span class="Validform_checktip"></span>
            ...
            <tr>
                ...
                <td class="value">
                    ...
                    <t:dictSelect field="commentCheck" id="commentCheck"  typeGroupCode="yesorno" hasLabel="false" defaultVal="N" ></t:dictSelect>
                    <span class="Validform_checktip"></span>
