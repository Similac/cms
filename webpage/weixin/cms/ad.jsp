...
<html>
 <head>
  ...
  $(function () {
      ...
      //编辑时初始化图片预览
      var name = "${adPage.title}", imageHref = "${adPage.imageHref}";
      if(name != ""){
          $("#imageTitle").html(name);
      }
      if(imageHref != ""){
          $("#imageShow").html('<img src="${adPage.imageHref}" width="100%" height="160" />');
      }
  });
			...
			<div class="appmsg editing">
				<div class="appmsg_content" id="js_appmsg_preview">
						...
						<div id="files" class="files">
							<i class="appmsg_thumb default" id="imageShow">图片</i>
						</div>
		 		...
		 		<div class="inner">
					...
					<table cellpadding="0" cellspacing="1" class="formtable">
						<tr>
							...
							<td class="value">
								<input class="inputxt" id="title" name="title" style="width: 300px" value="${adPage.title}" datatype="*" onblur="setimageTitle(this)">
                        ...
                        <tr>
                            ...
                            <td class="value">
                                <t:dictSelect field="siteid" id="siteid" dictTable="weixin_cms_site" dictField="site_code" dictText="site_name" defaultVal="${adPage.siteid}"></t:dictSelect>
                                <span class="Validform_checktip"></span>
                                <label class="Validform_label" style="display: none;">标题</label>
                            </td>
                        </tr>
						<tr>
							...
							<td class="value">
							    ...
							    <input id="imageHref" name="imageHref" type="hidden" datatype="*" nullmsg="请添加图片" value="${adPage.imageHref}">
						...
						<tr>
							...
							<td class="value">
								<input class="inputxt" id="accountid" name="accountid" style="width: 300px" datatype="*" nullmsg="请定义图片宽度" value="${adPage.accountid}" >
								<span class="Validform_checktip"></span>
								<label class="Validform_label" style="display: none;">标题</label>
							</td>
						</tr>
						<tr>
							...
							<td class="value">
								<input class="inputxt" id="imageName" name="imageName" style="width: 300px" value="${adPage.imageName}" >
								<span class="Validform_checktip"></span>
								<label class="Validform_label" style="display: none;">标题</label>
							</td>
						</tr>
