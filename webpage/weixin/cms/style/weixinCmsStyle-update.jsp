  ...
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" callback="@Override uploadFile" layout="table" action="weixinCmsStyleController.do?doUpdate" tiptype="1" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <input id="templateName" name="templateName" type="text" value="${weixinCmsStylePage.templateName}" datatype="*" readonly="readonly" style="width: 150px" class="inputxt" >
				...
				<tr>
					...
					<td class="value">
					     	 <input id="templateUrl" name="templateUrl" type="text" value="${weixinCmsStylePage.templateUrl}"  style="width: 300px" class="inputxt" datatype="*" >
							<span class="Validform_checktip"></span>
							<label class="Validform_label" style="display: none;">模板名称</label>
						</td>
				</tr>
