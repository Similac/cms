...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="adList" title="首页图片" actionUrl="adController.do?datagrid" idField="id" fit="true" sortName="createDate" sortOrder="desc">
   <t:dgCol title="编号" field="id" hidden="false"></t:dgCol>
   <t:dgCol title="标题" field="title"></t:dgCol>
   <t:dgCol title="图片名称" field="imageName" hidden="false"></t:dgCol>
   <t:dgCol title="所属站点" field="siteid" dictionary="weixin_cms_site,site_code,site_name"></t:dgCol>
   <t:dgCol title="图片地址" field="imageHref"  imageSize="100,50" ></t:dgCol>
   <t:dgCol title="宽度" field="accountid" ></t:dgCol>
