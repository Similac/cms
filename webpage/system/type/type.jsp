...
<t:formvalid formid="formobj" layout="div" dialog="true" action="systemController.do?saveType">
	...
	<fieldset class="step">
	<div class="form"><label class="Validform_label"> 参数名称: </label> <input name="typename" class="inputxt" value="${type.typename }" datatype="s1-50"> <span class="Validform_checktip">类型范围在1~50位字符</span>
	</div>
	<div class="form"><label class="Validform_label"> 参数英文名称: </label> <input name="typeenname" class="inputxt" value="${type.typeenname }"> <span class="Validform_checktip">类型范围在1~50位字符</span>
	</div>
