...
<script type="text/javascript">
    ...
    $(function() {
        ...
        $("#resetBtn").click(function() {
            $.post("weblogController.do?monthlyStat&renderContainer=month_container&monthflag=1", "", showGraphReport);
    ...
    function show(param){
        //显示趋势图
        $.post("weblogController.do?monthlyStat&renderContainer=month_container&monthflag=1", getParam(), showGraphReport);
