...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="dblogList" checkbox="true" fitColumns="false" title="日志" actionUrl="weblogController.do?dbdatagrid" idField="id" fit="true" queryMode="group">
   <t:dgCol title="主键"  field="id"  hidden="false"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="创建人名称"  field="createName"  hidden="false"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="修改人名称"  field="updateName"  hidden="false"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="修改日期"  field="updateDate"  hidden="false"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="访问资源"  field="logPage"  query="true" dictionary="dbtab,id,cnname" hidden="true" queryMode="single"  ></t:dgCol>
   ...
   <t:dgCol title="访问站点"  field="logSite"  hidden="true" dictionary="weixin_cms_site,SITE_CODE,SITE_NAME" queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="访问时间"  field="createDate" formatter="yyyy-MM-dd hh:mm:ss" hidden="true" query="true"  queryMode="group"  width="127"></t:dgCol>
 ...
 $(document).ready(function(){
 		//给时间控件加上样式
  $("#dblogListtb").find("input[name='createDate_begin']").attr("class","Wdate").attr("style","height:20px;width:90px;").click(function(){WdatePicker({dateFmt:'yyyy-MM-dd'});});
  $("#dblogListtb").find("input[name='createDate_end']").attr("class","Wdate").attr("style","height:20px;width:90px;").click(function(){WdatePicker({dateFmt:'yyyy-MM-dd'});});
     //给时间控件加上样式
