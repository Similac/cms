...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="dbRestypeController.do?doUpdate" tiptype="1">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="restypename" name="restypename" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${dbRestypePage.restypename}'>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="restypeenname" name="restypeenname" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${dbRestypePage.restypeenname}'>
							<span class="Validform_checktip"></span>
