 ...
 <div class="main_bd">
				...
				<div class="appmsg editing">
					<div class="appmsg_content" id="js_appmsg_preview">
							...
							<div id="files" class="files">
								<i style="height:160px;overflow:hidden;display:inline-block;width:100%;"><img src="${weixinOpenclassPage.picurl}" width="100%" height="160" /></i>
							</div>
		 ...
		 <div class="media_edit_area" id="js_appmsg_editor">	
 			<div class="appmsg_editor" style="margin-top: 0px;">
	 			<div class="inner">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="weixinOpenclassController.do?doUpdate" tiptype="1">
					<input id="id" name="id" type="hidden" value="${weixinOpenclassPage.id }">
					<input id="createName" name="createName" type="hidden" value="${weixinOpenclassPage.createName }">
					<input id="createDate" name="createDate" type="hidden" value="${weixinOpenclassPage.createDate }">
					<input id="updateName" name="updateName" type="hidden" value="${weixinOpenclassPage.updateName }">
					<input id="updateDate" name="updateDate" type="hidden" value="${weixinOpenclassPage.updateDate }">
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <input id="title" name="title" type="text" style="width: 250px" class="inputxt" value="${weixinOpenclassPage.title }">
				...
				<tr>
					...
					<td class="value">
					     	<textarea id="description" name="description"  style="width: 350px" class="inputxt"  cols="8" rows="2" >${weixinOpenclassPage.description }</textarea>
					...
					<td align="right">
						...
						<td class="value">
								<span class="btn btn-success fileinput-button">
							        ...
							        <input id="picurl" name=picurl type="hidden" value="${weixinOpenclassPage.picurl }" datatype="*" nullmsg="请添加图片">
							    </span>
				...
				<tr>
					...
					<td class="value">
					     	 <textarea id="url" name="url"  style="width: 350px" class="inputxt"  cols="8" rows="2">${weixinOpenclassPage.url }</textarea>
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="sortid" name="sortid"  type="text" style="width: 50px" class="inputxt" value="${weixinOpenclassPage.sortid }">
							<span class="Validform_checktip"></span>
  ...
  <script src = "webpage/web/weixin/weixinOpenclass.js"></script>		