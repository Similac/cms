 ...
 <div class="main_bd">
		 ...
		 <div class="media_edit_area" id="js_appmsg_editor">	
 			<div class="appmsg_editor" style="margin-top: 0px;">
	 			<div class="inner">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="weixinMagazineController.do?doAdd" tiptype="1">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <input id="title" name="title" type="text" style="width: 250px" class="inputxt" >
				...
				<tr>
					...
					<td class="value">
					     	 <textarea id="description" name="description"  style="width: 350px" class="inputxt"  cols="8" rows="2" ></textarea>
					...
					<td align="right">
						...
						<td class="value">
								<span class="btn btn-success fileinput-button">
							        ...
							        <input id="picurl" name=picurl type="hidden"  datatype="*" nullmsg="请添加图片">
							    </span>
				...
				<tr>
					...
					<td class="value">
					     	 <textarea id="url" name="url"  style="width: 350px" class="inputxt"  cols="8" rows="2"></textarea>
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="sortid" name="sortid" value="8" type="text" style="width: 50px" class="inputxt">
							<span class="Validform_checktip"></span>
