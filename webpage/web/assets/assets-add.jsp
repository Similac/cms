...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="assetsController.do?doAdd">
		...
		<tr>
			...
			<td class="value">
					<t:dictSelect field="astype" type="list"
						dictTable="assets_type" dictField="id" dictText="typename"  hasLabel="false"  title="类型"></t:dictSelect>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					<t:dictSelect field="asstate" type="list"
						typeGroupCode="assets_state"  hasLabel="false"  title="状态"></t:dictSelect>     
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					<t:dictSelect field="nowdept" type="list"
						dictTable="t_s_depart" dictField="ID" dictText="departname"  hasLabel="false"  title="所在部门"></t:dictSelect>     
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					<t:dictSelect field="bedept" type="list"
						dictTable="t_s_depart" dictField="ID" dictText="departname"  hasLabel="false"  title="前所在部门"></t:dictSelect>     
				<span class="Validform_checktip"></span>
